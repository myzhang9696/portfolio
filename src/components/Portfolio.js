          ...
          >
            ...
            >
              <div className="img_holder">
                ...
                <div className="abs_img" data-bg-img="img/pennlobby.png" />
              </div>
              ...
              <div className="fn__hidden">
                <p className="fn__cat"> Group-Based Social Network Web App</p>
                <h3 className="fn__title">PennLobby</h3>
                <div className="img_holder">
                  <img src="img/thumb/square.jpg" alt="image" />
                  <div className="abs_img" data-bg-img="img/pennlobby.png" />
                </div>
            ...
            >
              <div className="img_holder">
                <img src="img/thumb/square.jpg" alt="image" />
                <div className="abs_img" data-bg-img="img/celeb.png" />
              </div>
              <div className="title_holder">
                <p>Oct 2021 – Nov 2021</p>
                <h3>
                  <a href="#">Guess Celebrity Games</a>
                </h3>
              </div>
              <div className="fn__hidden">
            ...
            >
              <div className="img_holder">
                <img src="img/thumb/square.jpg" alt="image" />
                <div className="abs_img" data-bg-img="img/baltimore.png" />
              </div>
              <div className="title_holder">
                <p>Feb 2020 – May 2020</p>
                <h3>
                  <a href="#">Baltimore Fleet Optimization</a>
                </h3>
              </div>
              <div className="fn__hidden">
                <p className="fn__cat">Feb 2020 – May 2020</p>
                <h3 className="fn__title">BBaltimore Fleet Optimization</h3>
                <div className="img_holder">
                  <img src="img/thumb/square.jpg" alt="image" />
                  <div className="abs_img" data-bg-img="img/baltimore.png" />
                </div>
            ...
            >
              <div className="img_holder">
                <img src="img/thumb/square.jpg" alt="image" />
                <div className="abs_img" data-bg-img="img/ezscene.png" />
              </div>
              <div className="title_holder">
                <p>Nov 2020 – Aug 2021</p>
                <h3>
                  <a href="#">EzScene</a>
                </h3>
              </div>
            ...
            >
              <div className="img_holder">
                <img src="img/thumb/square.jpg" alt="image" />
                <div className="abs_img" data-bg-img="img/risk.jpg" />
              </div>
              <div className="title_holder">
