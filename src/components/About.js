      ...
      <div className="container">
        <div className="roww">
          ...
          <div className="resumo_fn_main_title">
            ...
            <p className="desc">
              {`I enjoy coding, creating beautiful websites makes me happy.
          ...
          <div className="resumo_fn_about_info">
            ...
            <div className="about_right">
              ...
              <div className="resumo_fn_cv_btn">
                <a href="files/Resume_Miaoyan_2022_1.pdf" download>
                  <span className="icon">
                    <svg
                  ...
                  <ul>
                    <li>
                      <div className="item">
                        <div className="item_top">
                          <h5>CityDNA</h5>
                          <span>( Nov 2020 — Aug 2021 )</span>
                        </div>
                        <h3>Sofrware Engineer</h3>
                        <p>
                        •	Independently implemented EzScene - a space-time scenario simulation application framework and 2D/3D webGL system.
                        •	Implemented EzDataManagement - a data management platform for users to CRUD database online.
                          {" "}
                        </p>
                      </div>
                    </li>
                    <li>
                      <div className="item">
                        ...
                        <h3>Software Development and Data Analysis Intern</h3>
                        <p>
                          •	Crawled over 5 million sales and rent data.
                          •	Further developed ArcPy algorithms.
                          •	Developed machine learning models to predict land-use with satellite imagery.
                          {" "}
                        </p>
                      </div>
                    </li>
                    <li>
                      <div className="item">
                        <div className="item_top">
                          <h5>World Resources Institute</h5>
                          <span>( Feb 2019 – Jun 2019 )</span>
                        </div>
                        <h3>Analytics Intern</h3>
                        <p>
                  ...
                  <ul>
                    ...
                    <li>
                      <div className="item">
                        ...
                        <h3>Master of Urban Spatial Analytics</h3>
                        <p>
                        GPA 3.71/4{" "}
                        </p>
                      </div>
